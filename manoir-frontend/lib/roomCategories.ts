...
export const ROOM_CATEGORY_ORDER: RoomCategory[] = ["vip", "deux_chambres", "une_chambre"];
...
export const ROOM_CATEGORY_CONFIG: Record<RoomCategory, RoomCategoryConfig> = {
  ...
  une_chambre: {
    ...
    aliases: ["une-chambre", "une_chambre", "appartement-1ch-1", "appartement-1ch-2"]
  }
};
...
export const formatCurrency = (value: number) => `${value.toLocaleString("fr-FR")} F`;
